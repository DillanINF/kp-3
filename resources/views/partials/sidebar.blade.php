        ...
        <div class="space-y-1">
            ...
            <details class="group rounded-md" @if(request()->routeIs('masters.*')) open @endif>
                ...
                <div class="mt-1 space-y-1 pl-11">
                    ...
                    <a href="{{ route('masters.pengirim') }}" class="sidebar-link block rounded-md px-3 py-2 text-sm text-slate-600 transition-colors hover:bg-slate-100 hover:text-slate-900 {{ request()->routeIs('masters.pengirim') ? 'bg-slate-100 text-slate-900' : '' }}">Data Pengirim</a>
