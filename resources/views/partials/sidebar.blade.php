<div class="flex h-full flex-col">
    ...
    <nav class="flex-1 overflow-y-auto px-3 py-4">
        <div class="space-y-1">
            <a href="{{ route('dashboard') }}" class="sidebar-link group flex items-center gap-3 rounded-md px-3 py-2 text-sm font-medium text-slate-700 transition-colors hover:bg-slate-100 hover:text-slate-900">
            ...
            <details class="group rounded-md">
                ...
                <div class="mt-1 space-y-1 pl-11">
                    <a href="{{ route('invoices.index') }}" class="sidebar-link block rounded-md px-3 py-2 text-sm text-slate-600 transition-colors hover:bg-slate-100 hover:text-slate-900">Data Invoice</a>
                    <a href="{{ route('invoices.po_pending') }}" class="sidebar-link block rounded-md px-3 py-2 text-sm text-slate-600 transition-colors hover:bg-slate-100 hover:text-slate-900">PO Belum Terkirim</a>
                </div>
            </details>

            @if(auth()->check() && in_array(auth()->user()?->role, ['admin', 'manager'], true))
                <a href="{{ route('reports.index') }}" class="sidebar-link group flex items-center gap-3 rounded-md px-3 py-2 text-sm font-medium text-slate-700 transition-colors hover:bg-slate-100 hover:text-slate-900">
                    <span class="sidebar-icon flex h-8 w-8 items-center justify-center rounded-md bg-slate-100 text-slate-700 transition-colors group-hover:bg-slate-300">
                        <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="h-4 w-4">
            ...
            <details class="group rounded-md">
                ...
                <div class="mt-1 space-y-1 pl-11">
                    <a href="{{ route('masters.customers') }}" class="sidebar-link block rounded-md px-3 py-2 text-sm text-slate-600 transition-colors hover:bg-slate-100 hover:text-slate-900">Data Customer</a>
                    <a href="{{ route('masters.suppliers') }}" class="sidebar-link block rounded-md px-3 py-2 text-sm text-slate-600 transition-colors hover:bg-slate-100 hover:text-slate-900">Data Supplier</a>
                    <a href="{{ route('masters.items_supplier') }}" class="sidebar-link block rounded-md px-3 py-2 text-sm text-slate-600 transition-colors hover:bg-slate-100 hover:text-slate-900">Data Barang Supplier</a>
                    <a href="{{ route('masters.items') }}" class="sidebar-link block rounded-md px-3 py-2 text-sm text-slate-600 transition-colors hover:bg-slate-100 hover:text-slate-900">Data Barang</a>
                    <a href="{{ route('masters.items_in') }}" class="sidebar-link block rounded-md px-3 py-2 text-sm text-slate-600 transition-colors hover:bg-slate-100 hover:text-slate-900">Data Barang Masuk</a>
                    <a href="{{ route('masters.items_out') }}" class="sidebar-link block rounded-md px-3 py-2 text-sm text-slate-600 transition-colors hover:bg-slate-100 hover:text-slate-900">Data Barang Keluar</a>
                </div>
            </details>

            <a href="{{ route('settings') }}" class="sidebar-link group flex items-center gap-3 rounded-md px-3 py-2 text-sm font-medium text-slate-700 transition-colors hover:bg-slate-100 hover:text-slate-900">
                <span class="sidebar-icon flex h-8 w-8 items-center justify-center rounded-md bg-slate-100 text-slate-700 transition-colors group-hover:bg-slate-300">
                    <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="h-4 w-4">
